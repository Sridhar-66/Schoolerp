  ...
  return (
    <div className="flex flex-col gap-6 p-6">
      ...
      <div className="rounded-md border bg-white shadow-sm">
        // Update the Table inside src/app/(admin)/admin/examinations/page.tsx
<Table>
  ...
  <TableBody>
    {loading ? (
      <TableRow>
        <TableCell colSpan={7} className="text-center py-10 text-slate-400 animate-pulse font-medium">
      ...
      exams.map((exam) => (
        <TableRow key={exam.id} className="hover:bg-slate-50/40 transition-colors">
          ...
          <TableCell className="text-right">
            <Button variant="outline" size="sm" asChild className="text-xs h-8 font-semibold border-indigo-200 text-indigo-600 hover:bg-indigo-50">
              <a href={`/admin/examinations/results/${exam.id}`}>
                Enter Marks
              </a>
            </Button>
          </TableCell>
